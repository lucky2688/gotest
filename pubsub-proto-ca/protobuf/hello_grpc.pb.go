...
const (
	PubsubService_Publish_FullMethodName   = "/main.PubsubService/Publish"
	PubsubService_Subscribe_FullMethodName = "/main.PubsubService/Subscribe"
)
...
const (
	HelloService_SomeMethod_FullMethodName = "/main.HelloService/SomeMethod"
)
...
type HelloServiceClient interface {
	SomeMethod(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *helloServiceClient) SomeMethod(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, HelloService_SomeMethod_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServiceServer interface {
	SomeMethod(context.Context, *HelloRequest) (*HelloReply, error)
...
func (UnimplementedHelloServiceServer) SomeMethod(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _HelloService_SomeMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloServiceServer).SomeMethod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloService_SomeMethod_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).SomeMethod(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _HelloService_SomeMethod_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "hello.proto",
